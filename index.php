...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/strap.css" media="screen">
    ...
    <div class="navbar navbar-default navbar-fixed-top" style="background:transparent; background-color:transparent;">
      <div class="container" >
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">
            <li class="dropdown">
              <a style="color: #4582ec" class="dropdown-toggle" data-toggle="dropdown" id="themes"></a>
            </li>
            <li>
              <a style="color: #4582ec" href="javascript:;" data-toggle="modal" data-target="#paid-info-modal">ABOUT</a>
            </li>
            <li>
              <a style="color: #4582ec" href="http://news.bootswatch.com">Blog</a>
            </li>
            <li class="dropdown">
            ...
            <ul style="position:relative;">
                <input placeholder="Username" style="width:150px; margin-left:195px; margin-top:15px; margin-right: 15px;" type="text" class="input-sm form-control col-lg-8" name="email" value=""> 
                    <input placeholder="Password" style="margin-left:0px;margin-right: 15px; width:150px; margin-top:15px; margin-bottom:10px;" type="password" class="input-sm form-control col-lg-8" name="password" value="">
                    <button class="btn btn-primary btn-sm" style="margin-top:15px; margin-left:auto; margin-right: 15px;">Login</button><button style="margin-top:15px;" class="btn btn-sm btn-default" style="color: #000000" href="#">REGISTER</button>
      ...
      <div class="page-header" id="banner">
        <div class="row">
          ...
          <div style="margin-top:100px;" class="col-lg-12">
            <img align="middle" style="position: absolute; top:-120px; left:260px;height:100px; weight:100px;" src="img/nashordb_logo.png"/>
              <br>
            <h2 align="middle" style="margin-bottom:7px; margin-top: -5px; color:white;">LOG YOUR SOLO Q STATS</h2>
            <h2 align="middle" class="bs-component" style="color:white; margin-top: px; margin-bottom:7px;">ENTER POST GAME DETAILS, IMPROVE YOUR PLAY!</h2>
          </div>
