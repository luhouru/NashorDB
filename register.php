...
$db = mysqli_connect("localhost", "root", "supfoo2971", "users");
    ...
    if ($num_rows == 0) {
        ...
        $stats_result = mysqli_query($db, "CREATE TABLE ".$username." (entry_id bigint(20), division  varchar(255), lp bigint(20), gain varchar(8), champion varchar(20), position varchar(20), kda varchar(30), cs int(10), mistakes varchar(255), improve_by varchar(255), AUTO_INCREMENT PRIMARY KEY (entry_id) );");
